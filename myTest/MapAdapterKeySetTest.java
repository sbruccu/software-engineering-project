...
public class MapAdapterKeySetTest {
    ...
    /**
     * Tests keySet.toArray(Object[]) with an exactly sized array.
     * <p>
     * <table border="1">
     * <caption></caption>
     * <tr><th>Summary</th><td>Tests keySet.toArray(Object[]) with an exactly sized array.</td></tr>
     ...
     */
    @Test
    public void testKeySetToArrayExactSize() {
        map.put("A", "1");
        map.put("B", "2");
        Object[] input = new Object[2];
        Object[] output = map.keySet().toArray(input);
